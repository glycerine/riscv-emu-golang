...
func TestMUL_NegPos(t *testing.T) {
	runOne(t, renc(0x33, 0, 0x01, 1, 2, 3), regs(2, ^uint64(0), 3, 2), nil)
} // -1*2=-2
func TestMUL_NegNeg(t *testing.T) {
	runOne(t, renc(0x33, 0, 0x01, 1, 2, 3), regs(2, ^uint64(0), 3, ^uint64(0)), nil)
} // -1*-1=1
func TestMUL_Overflow(t *testing.T) {
	runOne(t, renc(0x33, 0, 0x01, 1, 2, 3), regs(2, 0x8000000000000000, 3, 2), nil)
}
func TestMUL_Large(t *testing.T) {
	runOne(t, renc(0x33, 0, 0x01, 1, 2, 3), regs(2, 0xDEADBEEF, 3, 0xCAFEBABE), nil)
}
...
func TestMULH_MinMin(t *testing.T) {
	runOne(t, renc(0x33, 1, 0x01, 1, 2, 3), regs(2, 0x8000000000000000, 3, 0x8000000000000000), nil)
}
func TestMULH_Large(t *testing.T) {
	runOne(t, renc(0x33, 1, 0x01, 1, 2, 3), regs(2, 0x7FFFFFFFFFFFFFFF, 3, 0x7FFFFFFFFFFFFFFF), nil)
}
...
func TestMULHU_Large(t *testing.T) {
	runOne(t, renc(0x33, 3, 0x01, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 0xFFFFFFFFFFFFFFFF), nil)
}
func TestMULHU_Max(t *testing.T) {
	runOne(t, renc(0x33, 3, 0x01, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 2), nil)
}
...
func TestDIV_Negative(t *testing.T) {
	runOne(t, renc(0x33, 4, 0x01, 1, 2, 3), regs(2, ^uint64(6)+1, 3, 2), nil)
} // -6/2=-3
func TestDIV_NegNeg(t *testing.T) {
	runOne(t, renc(0x33, 4, 0x01, 1, 2, 3), regs(2, ^uint64(6)+1, 3, ^uint64(2)+1), nil)
}                                   // -6/-2=3
func TestDIV_Truncate(t *testing.T) { runOne(t, renc(0x33, 4, 0x01, 1, 2, 3), regs(2, 7, 3, 2), nil) } // 7/2=3 (truncate toward zero)
func TestDIV_NegTruncate(t *testing.T) {
	runOne(t, renc(0x33, 4, 0x01, 1, 2, 3), regs(2, ^uint64(7)+1, 3, 2), nil)
} // -7/2=-3
...
func TestDIVU_Large(t *testing.T) {
	runOne(t, renc(0x33, 5, 0x01, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 2), nil)
}
func TestDIVU_NegAsUnsigned(t *testing.T) {
	runOne(t, renc(0x33, 5, 0x01, 1, 2, 3), regs(2, ^uint64(0), 3, ^uint64(0)), nil)
} // (2^64-1)/(2^64-1)=1
...
func TestREM_Negative(t *testing.T) {
	runOne(t, renc(0x33, 6, 0x01, 1, 2, 3), regs(2, ^uint64(7)+1, 3, 3), nil)
} // -7%3=-1
func TestREM_Overflow(t *testing.T) {
	runOne(t, renc(0x33, 6, 0x01, 1, 2, 3), regs(2, 0x8000000000000000, 3, ^uint64(0)), nil)
}                                // INT_MIN%-1 -> 0
...
func TestREMU_Large(t *testing.T) {
	runOne(t, renc(0x33, 7, 0x01, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 3), nil)
}
...
func TestMULW_SignExtend(t *testing.T) {
	runOne(t, renc(0x3B, 0, 0x01, 1, 2, 3), regs(2, 0x80000000, 3, 2), nil)
} // overflows into negative
func TestMULW_Neg(t *testing.T) {
	runOne(t, renc(0x3B, 0, 0x01, 1, 2, 3), regs(2, ^uint64(1)+1, 3, 2), nil)
} // -2*2=-4 as 32-bit
func TestMULW_IgnoresUpper(t *testing.T) {
	runOne(t, renc(0x3B, 0, 0x01, 1, 2, 3), regs(2, 0xDEADBEEF00000007, 3, 6), nil)
} // upper bits ignored
...
func TestDIVW_Negative(t *testing.T) {
	runOne(t, renc(0x3B, 4, 0x01, 1, 2, 3), regs(2, ^uint64(6)+1, 3, 2), nil)
}
...
func TestREMW_Overflow(t *testing.T) {
	runOne(t, renc(0x3B, 6, 0x01, 1, 2, 3), regs(2, 0x80000000, 3, ^uint64(0)), nil)
} // -> 0

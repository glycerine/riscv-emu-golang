...
func TestADDI_Overflow(t *testing.T) {
	runOne(t, ienc(0x13, 0, 1, 2, 1), regs(2, 0xFFFFFFFFFFFFFFFF), nil)
}
...
func TestSLTI_NegLtPos(t *testing.T) {
	runOne(t, ienc(0x13, 2, 1, 2, 1), regs(2, 0xFFFFFFFFFFFFFFFF), nil)
}
func TestSLTIU_True(t *testing.T) { runOne(t, ienc(0x13, 3, 1, 2, 10), regs(2, 5), nil) }
func TestSLTIU_BigUnsigned(t *testing.T) {
	runOne(t, ienc(0x13, 3, 1, 2, 1), regs(2, 0xFFFFFFFFFFFFFFFF), nil)
}
...
func TestSRAI_Negative(t *testing.T) {
	runOne(t, senc(0x13, 5, 1, 2, 4, true), regs(2, 0xFFFFFFFFFFFFFFFF), nil)
}
func TestSRAI_Positive(t *testing.T) { runOne(t, senc(0x13, 5, 1, 2, 1, true), regs(2, 100), nil) }
func TestSRAI_Shamt35(t *testing.T) {
	runOne(t, senc(0x13, 5, 1, 2, 35, true), regs(2, 0xC730303030303030), nil)
}
...
func TestADD_Overflow(t *testing.T) {
	runOne(t, renc(0x33, 0, 0x00, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 1), nil)
}
...
func TestSLT_NegLtPos(t *testing.T) {
	runOne(t, renc(0x33, 2, 0x00, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 1), nil)
}
...
func TestSRA_Neg(t *testing.T) {
	runOne(t, renc(0x33, 5, 0x20, 1, 2, 3), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 1), nil)
}
...
func TestSRAIW_Neg(t *testing.T) {
	runOne(t, senc(0x1B, 5, 1, 2, 4, true), regs(2, 0xFFFFFFFF80000000), nil)
}

// ── ADDW / SUBW / SLLW / SRLW / SRAW ─────────────────────────────────────

func TestADDW(t *testing.T) { runOne(t, renc(0x3B, 0, 0x00, 1, 2, 3), regs(2, 100, 3, 200), nil) }
func TestADDW_SignExtend(t *testing.T) {
	runOne(t, renc(0x3B, 0, 0x00, 1, 2, 3), regs(2, 0x7FFFFFFF, 3, 1), nil)
}
...
func TestSRAW_Neg(t *testing.T) {
	runOne(t, renc(0x3B, 5, 0x20, 1, 2, 3), regs(2, 0xFFFFFFFF80000000, 3, 1), nil)
}
...
func TestBLT_Taken(t *testing.T) {
	runOne(t, benc(0x63, 4, 2, 3, 8), regs(2, 0xFFFFFFFFFFFFFFFF, 3, 1), nil)
}
...
func TestLH_Neg(t *testing.T) {
	runOne(t, lenc(0x03, 1, 1, 2, 0), regs(2, oracleDataVA), []byte{0x00, 0x80})
}
func TestLHU(t *testing.T) {
	runOne(t, lenc(0x03, 5, 1, 2, 0), regs(2, oracleDataVA), []byte{0x00, 0x80})
}
func TestLW_Neg(t *testing.T) {
	runOne(t, lenc(0x03, 2, 1, 2, 0), regs(2, oracleDataVA), []byte{0xFF, 0xFF, 0xFF, 0x80})
}
func TestLWU(t *testing.T) {
	runOne(t, lenc(0x03, 6, 1, 2, 0), regs(2, oracleDataVA), []byte{0xFF, 0xFF, 0xFF, 0x80})
}
func TestLD(t *testing.T) {
	runOne(t, lenc(0x03, 3, 1, 2, 0), regs(2, oracleDataVA), []byte{0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE, 0xBA, 0xBE})
}

// ── Stores (x2 = oracleDataVA, x3 = value) ────────────────────────────────

func TestSB(t *testing.T) {
	runOne(t, lenc(0x23, 0, 2, 3, 0), regs(2, oracleDataVA, 3, 0xAB), make([]byte, 8))
}
func TestSH(t *testing.T) {
	runOne(t, lenc(0x23, 1, 2, 3, 0), regs(2, oracleDataVA, 3, 0xABCD), make([]byte, 8))
}
func TestSW(t *testing.T) {
	runOne(t, lenc(0x23, 2, 2, 3, 0), regs(2, oracleDataVA, 3, 0xDEADBEEF), make([]byte, 8))
}
func TestSD(t *testing.T) {
	runOne(t, lenc(0x23, 3, 2, 3, 0), regs(2, oracleDataVA, 3, 0xDEADBEEFCAFEBABE), make([]byte, 8))
}
func TestSB_Masking(t *testing.T) {
	runOne(t, lenc(0x23, 0, 2, 3, 0), regs(2, oracleDataVA, 3, 0xDEADBEEFCAFEBAFF), make([]byte, 8))
}
func TestSW_SignBit(t *testing.T) {
	runOne(t, lenc(0x23, 2, 2, 3, 0), regs(2, oracleDataVA, 3, 0x80000000), make([]byte, 8))
}

...
func TestC_LWSP(t *testing.T)  { runRVC(t, cLWSP(1, 0), regs(2, oracleDataVA), []byte{0xEF, 0xBE, 0xAD, 0xDE}) }
func TestC_LDSP(t *testing.T)  { runRVC(t, cLDSP(1, 0), regs(2, oracleDataVA), []byte{0xDE, 0xAD, 0xBE, 0xEF, 0xCA, 0xFE, 0xBA, 0xBE}) }
...
func TestC_SWSP(t *testing.T)  { runRVC(t, cSWSP(1, 0), regs(2, oracleDataVA, 1, 0xDEADBEEF), make([]byte, 8)) }
func TestC_SDSP(t *testing.T)  { runRVC(t, cSDSP(1, 0), regs(2, oracleDataVA, 1, 0xDEADBEEFCAFEBABE), make([]byte, 8)) }

...
// this is old resurrected C emitting code

// the per-block instruction budget (maxIC=4096)
// note: we don't want to use this (probably!) but brought
// it in to get an initial compilation going.
const maxIC = 4096

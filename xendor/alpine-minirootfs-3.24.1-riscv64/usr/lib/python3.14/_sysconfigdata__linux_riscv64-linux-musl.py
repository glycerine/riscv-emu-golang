...
build_time_vars = {
    ...
    'BLDSHARED': 'cc -shared -Wl,-z,stack-size=1048576',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '',
    'BUILDPYTHON': 'python',
    'BUILD_GNU_TYPE': 'riscv64-alpine-linux-musl',
    ...
    'CONFIGURE_CFLAGS': '',
    'CONFIGURE_CFLAGS_NODIST': '-Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden',
    'CONFIGURE_CPPFLAGS': '',
    'CONFIGURE_LDFLAGS': '-Wl,-z,stack-size=1048576',
    'CONFIGURE_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g',
    'CONFIGURE_LDFLAGS_NOLTO': '-fno-lto',
    'CONFIG_ARGS': "'--build=riscv64-alpine-linux-musl' '--host=riscv64-alpine-linux-musl' '--prefix=/usr' '--enable-ipv6' '--enable-loadable-sqlite-extensions' '--enable-optimizations' '--enable-shared' '--with-lto' '--with-computed-gotos' '--with-dbmliborder=gdbm:ndbm' '--with-system-expat' '--with-system-libmpdec' '--without-ensurepip' 'build_alias=riscv64-alpine-linux-musl' 'host_alias=riscv64-alpine-linux-musl' 'CC=cc'",
    'CONFINCLUDEDIR': '/usr/include',
    'CONFINCLUDEPY': '/usr/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/home/buildozer/aports/main/python3/src/Python-3.14.7/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/home/buildozer/aports/main/python3/src/Python-3.14.7/lcov-report',
    ...
    'EXTRATESTOPTS': '',
    'EXTRA_CFLAGS': '',
    'EXT_SUFFIX': '.cpython-314-riscv64-linux-musl.so',
    'FILEMODE': 644,
    ...
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': '',
    'HOST_GNU_TYPE': 'riscv64-alpine-linux-musl',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'c++ -shared -Wl,-z,stack-size=1048576',
    'LDFLAGS': '-Wl,-z,stack-size=1048576',
    'LDLIBRARY': 'libpython3.14.so',
    'LDLIBRARYDIR': '',
    'LDSHARED': 'cc -shared -Wl,-z,stack-size=1048576',
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/usr/lib/python3.14',
    'LIBDIR': '/usr/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -fPIC',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': '',
    'LIBPC': '/usr/lib/pkgconfig',
    'LIBPL': '/usr/lib/python3.14/config-3.14-riscv64-linux-musl',
    'LIBPYTHON': '',
    ...
    'MODULE_READLINE_CFLAGS': '-D_BSD_SOURCE -DNCURSES_WIDECHAR',
    ...
    'MODULE__CURSES_CFLAGS': '-D_BSD_SOURCE -DNCURSES_WIDECHAR',
    'MODULE__CURSES_DEPS': './Include/py_curses.h',
    'MODULE__CURSES_LDFLAGS': '-lncursesw',
    'MODULE__CURSES_PANEL_CFLAGS': '-D_BSD_SOURCE -DNCURSES_WIDECHAR -D_BSD_SOURCE -DNCURSES_WIDECHAR',
    ...
    'MULTIARCH': 'riscv64-linux-musl',
    'MULTIARCH_CPPFLAGS': '-DMULTIARCH=\\"riscv64-linux-musl\\"',
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall',
    'PY_CFLAGS_NODIST': '-Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc',
    'PY_COERCE_C_LOCALE': 1,
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-Wl,-z,stack-size=1048576 -Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 1,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-Wl,-z,stack-size=1048576',
    'PY_LDFLAGS_NODIST': '-Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000',
    'PY_LDFLAGS_NOLTO': '-Wl,-z,stack-size=1048576 -fno-lto -Wl,--as-needed,-O1,--sort-common -Wl,-z,stack-size=0x200000',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 1,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fno-semantic-interposition -flto -fuse-linker-plugin -ffat-lto-objects -g -std=c11 -Wextra -Wno-unused-parameter -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden -Os -fstack-clash-protection -Wformat -Werror=format-security -g -O2 -DTHREAD_STACK_SIZE=0x200000 -fprofile-use -fprofile-correction -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -fPIC',
    'PY_SUPPORT_TIER': 0,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 1,
    'Py_GIL_DISABLED': 0,
    ...
    'RESSRCDIR': '',
    'RETSIGTYPE': 'void',
    'RUNSHARED': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.14.7',
    'SCRIPTDIR': '/usr/lib',
    'SCRIPT_IDLE': 'build/scripts-3.14/idle3.14',
    'SCRIPT_PYDOC': 'build/scripts-3.14/pydoc3.14',
    'SETPGRP_HAVE_ARG': 0,
    'SHAREDMODS': 'Modules/array.cpython-314-riscv64-linux-musl.so Modules/_asyncio.cpython-314-riscv64-linux-musl.so Modules/_bisect.cpython-314-riscv64-linux-musl.so Modules/_csv.cpython-314-riscv64-linux-musl.so Modules/_heapq.cpython-314-riscv64-linux-musl.so Modules/_json.cpython-314-riscv64-linux-musl.so Modules/_lsprof.cpython-314-riscv64-linux-musl.so Modules/_pickle.cpython-314-riscv64-linux-musl.so Modules/_queue.cpython-314-riscv64-linux-musl.so Modules/_random.cpython-314-riscv64-linux-musl.so Modules/_remote_debugging.cpython-314-riscv64-linux-musl.so Modules/_struct.cpython-314-riscv64-linux-musl.so Modules/_interpreters.cpython-314-riscv64-linux-musl.so Modules/_interpchannels.cpython-314-riscv64-linux-musl.so Modules/_interpqueues.cpython-314-riscv64-linux-musl.so Modules/_zoneinfo.cpython-314-riscv64-linux-musl.so Modules/math.cpython-314-riscv64-linux-musl.so Modules/cmath.cpython-314-riscv64-linux-musl.so Modules/_statistics.cpython-314-riscv64-linux-musl.so Modules/_decimal.cpython-314-riscv64-linux-musl.so Modules/binascii.cpython-314-riscv64-linux-musl.so Modules/_bz2.cpython-314-riscv64-linux-musl.so Modules/_lzma.cpython-314-riscv64-linux-musl.so Modules/zlib.cpython-314-riscv64-linux-musl.so Modules/_dbm.cpython-314-riscv64-linux-musl.so Modules/_gdbm.cpython-314-riscv64-linux-musl.so Modules/readline.cpython-314-riscv64-linux-musl.so Modules/_md5.cpython-314-riscv64-linux-musl.so Modules/_sha1.cpython-314-riscv64-linux-musl.so Modules/_sha2.cpython-314-riscv64-linux-musl.so Modules/_sha3.cpython-314-riscv64-linux-musl.so Modules/_blake2.cpython-314-riscv64-linux-musl.so Modules/_hmac.cpython-314-riscv64-linux-musl.so Modules/pyexpat.cpython-314-riscv64-linux-musl.so Modules/_elementtree.cpython-314-riscv64-linux-musl.so Modules/_codecs_cn.cpython-314-riscv64-linux-musl.so Modules/_codecs_hk.cpython-314-riscv64-linux-musl.so Modules/_codecs_iso2022.cpython-314-riscv64-linux-musl.so Modules/_codecs_jp.cpython-314-riscv64-linux-musl.so Modules/_codecs_kr.cpython-314-riscv64-linux-musl.so Modules/_codecs_tw.cpython-314-riscv64-linux-musl.so Modules/_multibytecodec.cpython-314-riscv64-linux-musl.so Modules/unicodedata.cpython-314-riscv64-linux-musl.so Modules/fcntl.cpython-314-riscv64-linux-musl.so Modules/grp.cpython-314-riscv64-linux-musl.so Modules/mmap.cpython-314-riscv64-linux-musl.so Modules/_posixsubprocess.cpython-314-riscv64-linux-musl.so Modules/resource.cpython-314-riscv64-linux-musl.so Modules/select.cpython-314-riscv64-linux-musl.so Modules/_socket.cpython-314-riscv64-linux-musl.so Modules/syslog.cpython-314-riscv64-linux-musl.so Modules/termios.cpython-314-riscv64-linux-musl.so Modules/_posixshmem.cpython-314-riscv64-linux-musl.so Modules/_multiprocessing.cpython-314-riscv64-linux-musl.so Modules/_ctypes.cpython-314-riscv64-linux-musl.so Modules/_curses.cpython-314-riscv64-linux-musl.so Modules/_curses_panel.cpython-314-riscv64-linux-musl.so Modules/_sqlite3.cpython-314-riscv64-linux-musl.so Modules/_ssl.cpython-314-riscv64-linux-musl.so Modules/_hashlib.cpython-314-riscv64-linux-musl.so Modules/xxsubtype.cpython-314-riscv64-linux-musl.so Modules/_xxtestfuzz.cpython-314-riscv64-linux-musl.so Modules/_testbuffer.cpython-314-riscv64-linux-musl.so Modules/_testinternalcapi.cpython-314-riscv64-linux-musl.so Modules/_testcapi.cpython-314-riscv64-linux-musl.so Modules/_testlimitedcapi.cpython-314-riscv64-linux-musl.so Modules/_testclinic.cpython-314-riscv64-linux-musl.so Modules/_testclinic_limited.cpython-314-riscv64-linux-musl.so Modules/_testimportmultiple.cpython-314-riscv64-linux-musl.so Modules/_testmultiphase.cpython-314-riscv64-linux-musl.so Modules/_testsinglephase.cpython-314-riscv64-linux-musl.so Modules/_ctypes_test.cpython-314-riscv64-linux-musl.so Modules/xxlimited.cpython-314-riscv64-linux-musl.so Modules/xxlimited_35.cpython-314-riscv64-linux-musl.so',
    'SHELL': '/bin/sh -e',
    'SHLIBS': '-ldl',
    'SHLIB_SUFFIX': '.so',
    ...
    'SIZEOF_WCHAR_T': 4,
    'SIZEOF__BOOL': 1,
    'SOABI': 'cpython-314-riscv64-linux-musl',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.14.7 ./python -E',
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': 'LD_LIBRARY_PATH=/home/buildozer/aports/main/python3/src/Python-3.14.7 ./python -E -m test',
    ...
    'abs_builddir': '/home/buildozer/aports/main/python3/src/Python-3.14.7',
    'abs_srcdir': '/home/buildozer/aports/main/python3/src/Python-3.14.7',
